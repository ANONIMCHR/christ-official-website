...
Semua bagian yang bisa diubah-ubah ada di **satu file**: `config.js`.
File lain (`index.html`, `style.css`, `app.js`, `galaxy.js`) gak perlu disentuh.

## Cara custom

Buka `config.js`, terus edit:
